...
public class ReservasActivity extends AppCompatActivity implements ReservaAdapter.OnReservaClickListener {
     ...
     * para crear una nueva reserva y observa los cambios en la lista de reservas.
     *
    ...
    /**
     * Acción a realizar cuando se solicita modificar una reserva.
     * Inicia la actividad {@link ModificarReservasActivity} pasando el id de la reserva a editar.
     *
    ...
    /**
     * Acción a realizar cuando se solicita eliminar una reserva.
